...
async def process_tact(*, token: Annotated[str, Query()], body: ProcessTactModel):
    ...
    result = await inspector.exec_external_method('ATJoint', 'process_tact', {'iterate': iterate}, auth_token=token)
    return result
